...
class StringTest extends TestCase
{
     ...
     */
    public function testSplit($str, $pattern, $expected, $exception)
    {
        $string = new Str($str);
    ...
    public function dataProviderForTestSplit()
    {
        return
            [
                ...
                ['Hello,World', '/[\,]/', ['Hello', 'World'], null],
                ['Hello`World', '/`/', ['Hello', 'World'], null],
                ['Hello,World', ['this is no a string'], null, PrimitiveException::class],
                [
                    'Hello,World',
                    'this is not a valid regexp pattern',
                    null,
                    PrimitiveException::class
                ],
            ];
    }
    ...
    public function testInsertFailWithString()
    {
        $string = new Str('Keep Objective');

        $this->expectException(PrimitiveException::class);

        $string->insert('string', '30');
    }

    public function testInsertFailWithEmptyArray()
    {
        $string = new Str('Keep Objective');
    ...
    public function testInsertFailWithArray()
    {
        $string = new Str('Keep Objective');
