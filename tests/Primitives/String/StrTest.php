<?php
    ...
    use ObjectivePHP\Primitives\Exception\InvalidParametersException;
...
//        }
        ...
        public function dataProviderForTestSplit()
        {
            return
                [
                    ...
                    ['Hello,World', '/[\,]/', ['Hello', 'World'], null, null],
                    ['Hello`World', '/`/', ['Hello', 'World'], null, null],
                    ['Hello,World', ['this is no a string'], null, InvalidParametersException::class, null],
                    ['Hello,World', 'this is not a valid regexp pattern', null, PrimitiveException::class, null],
                ];
        }
        ...
        public function testLocate()
        {
            ...
            {
                $string->locate([]);
            }, InvalidParametersException::class, 'Invalid needle type');
            ...
            }, InvalidParametersException::class, 'Offset cannot be negative');
